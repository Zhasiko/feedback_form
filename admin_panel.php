...
// Обработка отправки формы редактирования отзыва
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($reviewId) && !empty($editedMessage)) {
        // Обновление отзыва в базе данных с пометкой "изменен администратором"
...
<body>
    ...
    <a href="index.php">Вернуться к отзывам</a>
